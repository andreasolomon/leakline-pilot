...
import { AlertTriangle, AudioLines, CalendarDays, CheckCircle2, CreditCard, Database, FlaskConical, Link2, RefreshCw, ShieldCheck, Smartphone, Unplug, X } from 'lucide-react'
...
const providerIcons = { clickup: Database, quo: Smartphone, highlevel: Database, 'google-calendar': CalendarDays, stripe: CreditCard, whop: CreditCard, fanbasis: CreditCard, fathom: AudioLines }
