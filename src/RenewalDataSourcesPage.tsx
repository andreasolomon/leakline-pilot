...
const allowedProviders: ProviderId[] = ['clickup', 'highlevel', 'quo', 'whop', 'zoom']
...
export default function RenewalDataSourcesPage({
  ...
  return <section className="renewal-data-sources-page">
    ...
    <IntegrationPage
      ...
      canManage={canManage}
      manageableProviders={canSync ? ['clickup', 'highlevel', 'quo', 'zoom'] : []}
      canSync={canSync}
      ...
      heading={{
        ...
        description: canManage
          ? 'Connect ClickUp, GoHighLevel, Quo, Whop and Zoom. Credentials are validated server-side and encrypted before they are stored.'
          : canSync
            ? 'Connect ClickUp, GoHighLevel, Quo and Zoom, refresh renewal data or upload the latest exports. A client admin is still required for payment credentials.'
