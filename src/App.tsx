...
import LeakLineAssistant from './LeakLineAssistant'
import CoachingAttendancePage from './CoachingAttendancePage'
...
export default function App({ user, onLogout }: AppProps) {
  ...
  const navItems = isRenewalPilot ? [
    ...
    { label: 'Campaign tracking', display: 'Campaign Tracking', icon: Target },
    { label: 'KPI tracking', display: 'KPI Tracking', icon: BarChart3 },
    { label: 'Coaching attendance', display: 'Coaching Attendance', icon: Users },
  ...
  return (
    <div className="app-shell">
      ...
      {isRenewalPilot && <LeakLineAssistant
        workspaceId={user.workspaceId}
        workspaceName={currentWorkspace.clientName}
        onOpenRenewalCommand={() => openWorkspacePage('Renewal command')}
      />}
